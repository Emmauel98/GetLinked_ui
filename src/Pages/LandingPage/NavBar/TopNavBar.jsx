  ...
  return (
    <>
      <div
        ...
        px-[4vw] py-[5vh] bg-[rgba(21,14,40,0.6)] 
        lg:w-full w-full overflow-x-hidden 
      ...
      >
        ...
        <div className="hidden lg:block relative z-50">
          <ul className="flex gap-[5vw] cursor-pointer TopNavBarFont">
            <li
              className="hover:delay-100 hover:duration-100 transition-all hover:scale-[1.05]
           font-black ease-in-out time w-['auto'] relative text-center"
            >
              Timeline
            </li>
            <li
              className="hover:delay-100 hover:duration-300 transition-all hover:scale-[1.05]
           font-black ease-in-out relative text-center"
            >
              Overview
            </li>
            <li
        ...
        <div className="lg:hidden relative z-[200]">
          <img
            src={showMoreIcon}
            alt=""
            onClick={() => revealMobileNavBarHandle(true)}
          />
        </div>
      </div>
      {revealMobileNavBar && (
        <div>
          <SmallScreenNavBar hideTopNavBar={revealMobileNavBarHandle} />
        </div>
      )}
